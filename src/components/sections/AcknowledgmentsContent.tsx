      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="max-w-4xl mx-auto">
          <div className={`academic-header academic-fade-in ${isVisible ? 'visible' : ''}`}>
            <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-purple-500 to-pink-500 rounded-2xl mb-8 shadow-lg">
          ...
          <div className={`space-y-8 academic-fade-in ${isVisible ? 'visible' : ''}`} style={{ transitionDelay: '200ms' }}>
            {/* arXiv Acknowledgment */}
            <Card variant="research" className="academic-card">
